...
def get_hpc_files_from_path(path, ignore_patterns = None, use_gitignore = True, header_only = False):
...
def get_hpc_files(paths, ignore_patterns = None, use_gitignore = True, header_only = False):
    ...
    files = set()
    for path in paths:
        files |= get_hpc_files_from_path(path, ignore_patterns, use_gitignore, header_only)
    return list(files)
